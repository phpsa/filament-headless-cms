...
namespace Phpsa\FilamentHeadlessCms\Facades;
 ...
 *
 * @see \Phpsa\FilamentHeadlessCms\FilamentPageBlocksManager
 */
class FilamentCmsPageBlocks extends Facade
{
    protected static function getFacadeAccessor(): string
    {
        return 'filament-cms-page-blocks';
    }
}
